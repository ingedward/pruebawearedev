    ...
    <div class="md:grid grid-cols-2">
        <div class="w-full mx-auto space-y-4">
            ...
            <div class="form-control">
                ...
                <input type="number" id="price" name="price" disabled value="{{ $product->price }}" placeholder="Precio en $">
            </div>

            <div class="form-control">
                <label for="categoria">Categoria: </label>
                <input type="text" name="category" disabled value="{{ $product->category->name }}" placeholder="Categoría">
            </div>
        </div>
        <div>
